...
- [ ] 2.3 Navigation — cursor movement, enter directory / go to parent (`h`, left arrow — the listing has no `..` entry), top/bottom, page up/down, home; returning to a parent puts the cursor on the directory you came from; back/forward history.
